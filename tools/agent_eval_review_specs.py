    ...
    "meeting": {
        ...
        "MTG3": _case(
            ...
            _element(
                ...
                _REPLY,
                {"exactTargets": ["DL-9201", "DL-9202"], "forbiddenTarget": "DL-7001", "commentOnly": True, "reviewer": "skcc.x1327"},
            ),
        ),
        "MTG4": _case(
    ...
    "ctx-chg": {
        ...
        "CTX4": _case(
            ...
            _element(
                ...
                _REPLY + _RETRIEVAL,
                {"exactTargets": ["DL-9095"], "commentOnly": True, "forbidden": ["skcc.i2011", "이다은"]},
            ),
        ),
    },
    "editor": {
